...
| [0005](0005-channel-taxonomy-is-not-an-anchor.md) | A channel taxonomy is not an anchor | proposed |
| [0006](0006-bounded-recheck-for-adaptive-routes.md) | Bounded recheck for adaptive routes | proposed |
