# The Quest Lab Grimoire

Generated from `QuestEventCatalog.g.cs`; canonical event names remain evaluator-owned.
...
## Item Crafted — Kenaz (crafting)

- **Invocation:** *When the forge answers your hands...*
- **Canonical event:** `item_crafted`
- **Runtime profile:** `core`
- **School color:** `amber`
- **Quest use:** `BINDABLE`
...
## Station Fuel Added — Kenaz (crafting)

- **Invocation:** *When the forge answers your hands...*
- **Canonical event:** `station_fuel_added`
- **Runtime profile:** `core`
- **School color:** `amber`
- **Quest use:** `BINDABLE`

## Station Input Added — Kenaz (crafting)

- **Invocation:** *When the forge answers your hands...*
- **Canonical event:** `station_input_added`
- **Runtime profile:** `core`
- **School color:** `amber`
- **Quest use:** `BINDABLE`

## Station Output Collected — Kenaz (crafting)

- **Invocation:** *When the forge answers your hands...*
- **Canonical event:** `station_output_collected`
- **Runtime profile:** `core`
- **School color:** `amber`
- **Quest use:** `BINDABLE`

## Station Output Produced — Kenaz (crafting)

- **Invocation:** *When the forge answers your hands...*
- **Canonical event:** `station_output_produced`
- **Runtime profile:** `core`
- **School color:** `amber`
- **Quest use:** `BINDABLE`
