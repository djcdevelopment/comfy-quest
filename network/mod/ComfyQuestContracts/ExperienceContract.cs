...
public static class ExperienceCompiler {
  static readonly HashSet<string> Ops = new(StringComparer.OrdinalIgnoreCase) { "EVENT", "ANY", "ALL", "COUNT", "SEQUENCE", "THRESHOLD" };
