...
public static class QuestEventCatalog {
  ...
  static readonly Dictionary<string, Definition> _events =
    ...
    { "item_crafted", new Definition("item_crafted", "crafting", "core", "station", "the current crafting station prefab, or handcrafting when no station is used; the crafted item is not exposed", "piece_workbench", false, false, new FieldDefinition[0]) },
    ...
    { "piece_damaged", new Definition("piece_damaged", "building", "extended", "piece-prefab", "the damaged structure prefab", "woodwall", true, true, new FieldDefinition[0]) },
    { "piece_destroyed", new Definition("piece_destroyed", "building", "core", "piece-prefab", "the destroyed structure prefab", "woodwall", false, false, new FieldDefinition[0]) },
    { "piece_placed", new Definition("piece_placed", "building", "core", "piece-prefab", "the placed structure prefab", "woodwall", false, false, new FieldDefinition[0]) },
    ...
    { "piece_repaired", new Definition("piece_repaired", "building", "core", "piece-prefab", "the repaired structure prefab", "woodwall", false, false, new FieldDefinition[0]) },
    { "player_died", new Definition("player_died", "progression", "core", "player", "the local player", "you", false, false, new FieldDefinition[0]) },
    { "player_teleported", new Definition("player_teleported", "world", "core", "travel", "a successful local-player teleport; the production route does not infer its mechanism", "portal", false, false, new FieldDefinition[0]) },
