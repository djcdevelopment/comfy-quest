...
public sealed class WorkflowStateStore {
  ...
  static TriggerEvaluationContext Context(WorkflowProgress state,DateTimeOffset at)=>new(){At=at,StageEnteredUtc=state.StageEnteredUtc,LastProgressUtc=state.LastProgressUtc};
