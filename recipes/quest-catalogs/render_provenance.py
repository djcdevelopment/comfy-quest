...
PICKER_URL = "https://am4.tail8e749c.ts.net/questpicker/"
...
<section>
  ...
  <p class="caption">Solid lines are built and running. Dashed lines are where a
    human acts. <a href="__PICKER_URL__">Open the live quest picker</a> &middot;
    <a href="quest-picker.html">local copy</a> &middot;
...
<footer>
  <p class="fine">Generated by recipes/quest-catalogs/render_provenance.py.
    <a href="quest-picker.html">Quest picker</a> &middot;
    <a href="__PICKER_URL__">live picker</a></p>
</footer>
</div>
</body>
</html>
